        ...
        <div className="bg-white dark:bg-[#0A2540] rounded-3xl border border-black/5 dark:border-white/10 shadow-lg p-8" data-testid="auth-form">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-[#0A2540] text-[#475569] dark:text-gray-400">yoki</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-full border-2 border-black/10 dark:border-white/10 bg-white dark:bg-white/5 hover:bg-[#F5F7FA] dark:hover:bg-white/10 transition-all font-medium text-[#0A2540] dark:text-white"
